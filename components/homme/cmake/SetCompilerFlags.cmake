...
IF (${HOMME_USE_CXX})
  ...
  if (Kokkos_ENABLE_CUDA)
    ...
    IF (${pos} GREATER -1)
      MESSAGE (STATUS "Kokkos_ENABLE_CUDA=ON, and nvcc is set as C++ backend compiler. Great.")
    ELSE ()
      MESSAGE ("\n ********************************** WARNING ********************************** ")
      MESSAGE ("  Kokkos_ENABLE_CUDA=ON, but the backend C++ compiler is not nvcc_wrapper.")
