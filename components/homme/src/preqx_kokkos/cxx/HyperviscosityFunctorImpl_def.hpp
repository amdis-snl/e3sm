...
#ifndef HOMMEXX_HYPERVISCOSITY_FUNCTOR_IMPL_DEF_HPP
#define HOMMEXX_HYPERVISCOSITY_FUNCTOR_IMPL_DEF_HPP
...
HyperviscosityFunctorImplST (const SimulationParams&     params,
 ...
 : HyperviscosityFunctorImplST(geometry.num_elems(),params)
{
...
template<typename ST>
void HyperviscosityFunctorImplST<ST>::setup(const ElementsGeometry&     geometry,
                                      const ElementsState&        state,
                                      const ElementsDerivedState& derived)
{
  m_state = state;
...
template<typename ST>
void HyperviscosityFunctorImplST<ST>::biharmonic_wk_dp3d() const
{
...
#endif // HOMMEXX_HYPERVISCOSITY_FUNCTOR_IMPL_DEF_HPP
