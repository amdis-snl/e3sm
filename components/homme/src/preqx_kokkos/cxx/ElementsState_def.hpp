...
void ElementsStateST<ST>::init(const int num_elems) {
  ...
  m_v    = ExecViewManaged<PT * [NUM_TIME_LEVELS][2][NP][NP][NUM_LEV]>("Horizontal Velocity", m_num_elems);
  m_t    = ExecViewManaged<PT * [NUM_TIME_LEVELS]   [NP][NP][NUM_LEV]>("Temperature", m_num_elems);
  m_dp3d = ExecViewManaged<PT * [NUM_TIME_LEVELS]   [NP][NP][NUM_LEV]>("DP3D", m_num_elems);
