...
#ifndef HOMME_ELEMENTS_DEF_HPP
#define HOMME_ELEMENTS_DEF_HPP
...
void ElementsST<ST>::init(const int num_elems, const bool consthv, const bool alloc_gradphis,
...
template<typename ST>
void ElementsST<ST>::randomize(const int seed, const Real max_pressure) {
  randomize(seed,max_pressure,max_pressure/100,0.0);
}

template<typename ST>
void ElementsST<ST>::randomize(const int seed, const Real max_pressure, const Real ps0, const Real hyai0) {
